...
2. A description of which API endpoints you built
...
3. How you are using URL parameters and cookies
...
6. Identify where you challenged yourself or learned things not covered in class
